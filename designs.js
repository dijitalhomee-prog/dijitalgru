document.addEventListener('DOMContentLoaded', () => {
    ...
    const portfolioData = [
        ...
        },
        {
            ...
            challenge: "Bohem ve özgür ruhlu Akdeniz yaşam tarzını, lüks and seçkin bir gastronomi/konsept marka algısıyla harmanlayarak; el yapımı organik kağıt dokuları, toprak tonlarındaki renk paleti, el çizimi floral detaylar ve sürdürülebilir doğal ambalaj çözümleri sunan premium bir kurumsal kimlik kurgulamak."
        },
        {
            id: 22,
            title: "Ekmek Arası",
